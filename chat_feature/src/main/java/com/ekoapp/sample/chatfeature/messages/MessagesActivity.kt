            ...
            MaterialDialog(this).show {
                ...
                positiveButton(text = "un-flag a message") {
                    disposable.add(messageRepository.report(message.messageId)
                            ...
                            .observeOn(AndroidSchedulers.mainThread())
                            .doOnComplete {
                                Toast.makeText(this@MessagesActivity, "successfully un-flagged a message", Toast.LENGTH_SHORT).show()
                            }
                            .subscribe())
                }
            }
            ...
            MaterialDialog(this).show {
                ...
                positiveButton(text = "flag") {
                    disposable.add(messageRepository.report(message.messageId)
                            ...
                            .observeOn(AndroidSchedulers.mainThread())
                            .doOnComplete {
                                Toast.makeText(this@MessagesActivity, "successfully flagged the a message", Toast.LENGTH_SHORT).show()
                            }
                            .subscribe())
                }
            }
            ...
            MaterialDialog(this).show {
                ...
                positiveButton(text = "un-flag") {
                    disposable.add(userRepository.report(user.userId)
                            .unflag()
                            .observeOn(AndroidSchedulers.mainThread())
                            .doOnComplete { Toast.makeText(this@MessagesActivity, "successfully un-flagged a sender", Toast.LENGTH_SHORT).show() }
                            .subscribe())
                }
            }
            ...
            MaterialDialog(this).show {
                ...
                positiveButton(text = "flag") {
                    disposable.add(userRepository.report(user.userId)
                            .flag()
                            .observeOn(AndroidSchedulers.mainThread())
                            .doOnComplete { Toast.makeText(this@MessagesActivity, "successfully flagged a sender", Toast.LENGTH_SHORT).show() }
                            .subscribe())
                }
            }
        }
