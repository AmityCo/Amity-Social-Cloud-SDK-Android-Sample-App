...
import com.ekoapp.sample.core.SimpleConfig;
...
public class SimplePreferences {
    ...
    private static RxSharedPreferences init() {
        SharedPreferences preferences = App.Companion.get().getSharedPreferences("simple_preferences", Context.MODE_PRIVATE);
