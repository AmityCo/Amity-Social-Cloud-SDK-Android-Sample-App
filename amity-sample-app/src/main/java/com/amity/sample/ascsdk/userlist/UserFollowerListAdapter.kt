...
class UserFollowerListAdapter : PagedListAdapter<AmityFollowRelationship, UserFollowerListAdapter.UserFollowListViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: UserFollowListViewHolder, position: Int) {
        ...
        if (followStatus == null) {
            ...
            val text = StringBuilder()
                    .append("userId: ")
                    .append(followStatus.getSourceUser()?.getUserId())
                    .append("\ndisplay name: ")
                    .append(followStatus.getSourceUser()?.getDisplayName())
                    .append("\nfollow status: ")
