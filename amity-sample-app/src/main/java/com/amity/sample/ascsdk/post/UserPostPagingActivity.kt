...
class UserPostPagingActivity : PostPagingActivity() {
    ...
    private lateinit var userPostQueryBuilder: AmityUserPostQuery.Builder

    override fun onCreate(savedInstanceState: Bundle?) {
        userId = OpenUserPostPagingIntent.getUserId(intent)
        userPostQueryBuilder = AmitySocialClient
            .newPostRepository()
            .getPosts()
            .targetUser(userId)
    ...
    override fun sortPostCollection(checkedItem: Int): Flowable<PagingData<AmityPost>> {
        userPostQueryBuilder.apply { this.sortBy(AmityUserFeedSortOption.values()[checkedItem]) }
        return userPostQueryBuilder
            .build()
            .getPagingData()
    }
    ...
    override fun filterPostCollection(postTypes: List<AmityPost.Type>): Flowable<PagingData<AmityPost>> {
        userPostQueryBuilder.apply { this.types(postTypes = postTypes) }
        return userPostQueryBuilder
            .build()
            .getPagingData()
    }
    ...
    override fun getPostCollectionByIncludeDeleted(isIncludeDeleted: Boolean): Flowable<PagingData<AmityPost>> {
        userPostQueryBuilder.apply { this.includeDeleted(includeDeleted = isIncludeDeleted) }
        return userPostQueryBuilder
            .build()
            .getPagingData()
    }
