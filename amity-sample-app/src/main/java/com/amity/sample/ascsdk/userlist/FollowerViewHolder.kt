...
class FollowerViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
    ...
    fun bind(follow: AmityFollowRelationship) {
        val text = StringBuilder()
                .append("userId: ")
                .append(follow.getSourceUser()?.getUserId())
                .append("\ndisplay name: ")
                .append(follow.getSourceUser()?.getDisplayName())
                .append("\nfollow status: ")
    ...
    object FollowerDiffUtil : DiffUtil.ItemCallback<AmityFollowRelationship>() {
