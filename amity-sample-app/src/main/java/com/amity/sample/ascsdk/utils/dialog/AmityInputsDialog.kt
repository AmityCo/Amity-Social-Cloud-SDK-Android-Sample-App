package com.amity.sample.ascsdk.utils.dialog
...
import kotlinx.android.synthetic.main.dialog_amity_inputs.*

class AmityInputsDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(firstInputHint: String?, secondInputHint: String?,
                        textBtnLeft: String?, textBtnRight: String?): AmityInputsDialog {
            val fragment = AmityInputsDialog()
            val args = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.dialog_amity_inputs, container, false)
    }
    ...
    private fun setUpView() {
        if (firstInputHint.isNullOrEmpty()) {
            ...
            channelIdEditText.hint = firstInputHint
        }
        ...
        if (secondInputHint.isNullOrEmpty()) {
            ...
            displayNameInputEditText.hint = secondInputHint
        }
    ...
    private fun setUpListener() {
        ...
        rightButton.setOnClickListener {
            listener?.onRightClick(channelIdEditText.text.toString(), displayNameInputEditText.text.toString())
            dismissAllowingStateLoss()
        }
    }
