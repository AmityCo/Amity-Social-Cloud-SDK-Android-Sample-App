package com.amity.sample.ascsdk.common.file
...
class FileManager {
    companion object {
        fun openFile(context: Context, fileMessage: AmityMessage.Data.FILE) {
            val url = fileMessage.getFile()?.getUrl() ?: ""
            val dirPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()
            val fileName = fileMessage.getFile()?.getFileName() ?: ""
