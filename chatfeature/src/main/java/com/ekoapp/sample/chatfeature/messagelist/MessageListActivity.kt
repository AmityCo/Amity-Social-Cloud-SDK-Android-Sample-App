...
import com.ekoapp.sample.chatfeature.BaseActivity
import com.ekoapp.sample.chatfeature.R
import com.ekoapp.sample.chatfeature.file.FileManager
...
import com.ekoapp.sample.utils.PreferenceHelper.revertLayout
...
abstract class MessageListActivity : BaseActivity() {
    ...
    override fun onCreate(savedState: Bundle?) {
        ...
        defaultPreference(this).stackFromEnd = getDefaultStackFromEnd()
        defaultPreference(this).revertLayout = getDefaultRevertLayout()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.action_channel_membership) {
            ...
            MaterialDialog(this).show {
                checkBoxPrompt(text = getString(R.string.stack_from_end), isCheckedDefault = defaultPreference(context).stackFromEnd, onToggle = null)
                positiveButton(text = "save change") {
                    defaultPreference(context).stackFromEnd = isCheckPromptChecked()
                    initialMessageCollection()
                    observeMessageCollection()
                }
                negativeButton(text = "discard")
            ...
            MaterialDialog(this).show {
                checkBoxPrompt(text = getString(R.string.revert_layout), isCheckedDefault = defaultPreference(context).revertLayout, onToggle = null)
                positiveButton(text = "save change") {
                    defaultPreference(context).revertLayout = isCheckPromptChecked()
                    initialMessageCollection()
                    observeMessageCollection()
                }
                negativeButton(text = "discard")
    ...
    private fun initialMessageCollection() {
        ...
        layoutManager.stackFromEnd = defaultPreference(this).stackFromEnd
        layoutManager.reverseLayout = defaultPreference(this).revertLayout
