...
public class SimplePreferences {
    ...
    private static class SimplePreferencesHolder {
        ...
        private static final RxSharedPreferences INSTANCE = init(context);
    }

    private static RxSharedPreferences init(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("simple_preferences", Context.MODE_PRIVATE);
